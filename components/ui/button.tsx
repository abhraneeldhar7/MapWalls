  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-sm border border-transparent bg-clip-padding font-[400] whitespace-nowrap transition-all outline-none select-none  disabled:cursor-not-allowed aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:transition-all [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-[17px] duration-fast leading-[1em] cursor-pointer disabled:opacity-70 opacity-100 backdrop-blur-[5px]",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-muted text-foreground hover:text-foreground active:bg-muted aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-muted/70 disabled:hover:bg-[unset] dark:disabled:hover:bg-[unset] border-0 [&_svg]:mb-[3px]",
        destructive:
      ...
      size: {
        ...
        xs: "h-7 gap-1 rounded-xs px-2 text-xs in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
        sm: "h-9 sm:h-8 gap-2 rounded-xs px-2.5 text-xs in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-[14px] justify-start [&_svg]:mb-0",
        ...
        icon: "h-11 sm:h-10 aspect-square rounded-sm text-foreground shrink-0 [&_svg:not([class*='size-'])]:size-[16px] [&_svg]:transition-all",
        "icon-xs":
